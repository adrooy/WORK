...
class appdb(object):
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == obj2._meta.app_label:
            return True
        #User和Essay是允许关联的
        elif obj1._meta.app_label in ('web',) and obj2._meta.app_label in ('web',):
            return True
    ...
    def __app_router(self, model):
        ...
        if model._meta.app_label == 'market':
            ...
            return 'management'
        elif model._meta.app_label == 'testers':
            return 'testers'
#        elif model._meta.app_label == 'forum':
#            return 'forum'
        elif model._meta.app_label == 'fineapp':
            return 'forum'
        else:
            return 'default'
