...
class TopicInfo(models.Model):
    ...
    not_test = models.IntegerField('', max_length=11)
    topic_type = models.IntegerField('专题分类', max_length=11)
...
class CatToGame(models.Model):
    ...
    order_num = models.IntegerField('该游戏在分类下的排序', max_length=11)
    order_type = models.IntegerField('游戏的排序方式', max_length=11)
